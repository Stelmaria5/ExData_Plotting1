...
## 2
plot(powerdata$Time,powerdata$voltage, type = "l", ylab = "Voltage",
     xlab = "date/time")

## 3
plot(powerdata$Time,powerdata$Sub_metering_1, type = "l", ylab = "Energy sub metering",
     xlab = "")
...
## 4
plot(powerdata$Time,powerdata$Global_reactive_power, type = "l", 
     xlab = "date/time", ylab = "Global Rective Power")
